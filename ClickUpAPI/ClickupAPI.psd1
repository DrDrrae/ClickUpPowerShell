...
@{
    ...
    Copyright            = '(c) 2025 Andrea Mastellone. All rights reserved.'
    ...
    AliasesToExport      = @(
        ...
        'Get-ClickUpTeams',
        'Get-ClickupWorkspace',
        'Get-ClickupWorkspaces',
        'Get-ClickUpWorkspacePlan'
        'Get-ClickUpWorkspaceSeats'
    )
