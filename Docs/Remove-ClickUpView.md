...
```
Remove-ClickUpView [-ViewID] <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
https://jsapi.apiary.io/apis/clickup20/reference/0/views/get-view.html](https://jsapi.apiary.io/apis/clickup20/reference/0/views.html
https://jsapi.apiary.io/apis/clickup20/reference/0/views/get-view.html)
