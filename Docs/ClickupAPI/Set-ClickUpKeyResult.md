...
```
Set-ClickUpKeyResult [-KeyResultID] <string> [[-Name] <string>] [[-Note] <string>]
 [[-Owners] <ulong[]>] [[-Type] <string>] [[-StepsStart] <ulong>] [[-StepsEnd] <ulong>]
 [[-StepsCurrent] <ulong>] [[-Unit] <string>] [[-TaskIDs] <string[]>] [[-ListIDs] <ulong[]>]
 [<CommonParameters>]
```
