...
online version: https://jsapi.apiary.io/apis/clickup20/reference/0/dependencies/add-task-link.html
schema: 2.0.0
---
...
### CustomTaskID
```
Add-ClickUpTaskLink -TaskID <String> -LinksTo <String> -CustomTaskID <Boolean> -TeamID <UInt32>
 [<CommonParameters>]
```
...
[https://jsapi.apiary.io/apis/clickup20/reference/0/dependencies/add-task-link.html](https://jsapi.apiary.io/apis/clickup20/reference/0/dependencies/add-task-link.html)
